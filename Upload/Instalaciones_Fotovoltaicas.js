// Anthem/Upload/Instalaciones_Fotovoltaicas.js
import fs from "fs";
...
const posiblesCarpetas = [
  path.resolve(__dirname, "../datos_hpe/Instalaciones_Fotovoltaicas"),
  path.resolve(__dirname, "../datos_hpe/datos_hpe/Instalaciones_Fotovoltaicas"),
];
...
async function main() {
  ...
  const collection = mongoose.connection.db.collection("Instalaciones_Fotovoltaicas");
