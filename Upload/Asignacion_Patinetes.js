// Anthem/Upload/Asignacion_Patinetes.js
import fs from "fs";
...
const posiblesCarpetas = [
  path.resolve(__dirname, "../datos_hpe/Asignacion_Patinetes"),
  path.resolve(__dirname, "../datos_hpe/datos_hpe/Asignacion_Patinetes"),
];
...
async function main() {
  ...
  const collection = mongoose.connection.db.collection("Asignacion_Patinetes");
