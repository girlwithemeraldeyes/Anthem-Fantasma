...
const posiblesCarpetas = [
  path.resolve(__dirname, "../datos_hpe/Contenedores"),
  path.resolve(__dirname, "../datos_hpe/datos_hpe/Contenedores"),
];
...
async function main() {
  ...
  const collection = mongoose.connection.db.collection("Contenedores");
