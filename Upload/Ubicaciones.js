...
const posiblesCarpetas = [
  path.resolve(__dirname, "../datos_hpe/Ubicaciones"),
  path.resolve(__dirname, "../datos_hpe/datos_hpe/Ubicaciones"),
];
...
async function main() {
  ...
  const collection = mongoose.connection.db.collection("Ubicaciones");
