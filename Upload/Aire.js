...
const posiblesCarpetas = [
  path.resolve(__dirname, "../datos_hpe/Aire"),
  path.resolve(__dirname, "../datos_hpe/datos_hpe/Aire"),
];
...
async function main() {
  ...
  const collection = mongoose.connection.db.collection("Aire");
