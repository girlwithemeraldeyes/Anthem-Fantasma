...
const posiblesCarpetas = [
  path.resolve(__dirname, "../datos_hpe/Trafico"),
  path.resolve(__dirname, "../datos_hpe/datos_hpe/Trafico"),
];
...
async function main() {
  ...
  const collection = mongoose.connection.db.collection("Trafico");
