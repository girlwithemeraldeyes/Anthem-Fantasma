// Anthem/Upload/Disponibilidad_Bicicletas_Electricas.js
import fs from "fs";
...
const posiblesCarpetas = [
  path.resolve(__dirname, "../datos_hpe/Disponibilidad_Bicicletas_Electricas"),
  path.resolve(__dirname, "../datos_hpe/datos_hpe/Disponibilidad_Bicicletas_Electricas"),
];
...
async function main() {
  ...
  const collection = mongoose.connection.db.collection("Disponibilidad_Bicicletas_Electricas");
