// Anthem/Upload/Peatones_y_Bicicletas.js
import fs from "fs";
...
const posiblesCarpetas = [
  path.resolve(__dirname, "../datos_hpe/Peatones_y_Bicicletas"),
  path.resolve(__dirname, "../datos_hpe/datos_hpe/Peatones_y_Bicicletas"),
];
...
async function main() {
  ...
  const collection = mongoose.connection.db.collection("Peatones_y_Bicicletas");
