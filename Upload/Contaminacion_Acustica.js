// Anthem/Upload/Contaminacion_Acustica.js
import fs from "fs";
...
const posiblesCarpetas = [
  path.resolve(__dirname, "../datos_hpe/Contaminacion_Acustica"),
  path.resolve(__dirname, "../datos_hpe/datos_hpe/Contaminacion_Acustica"),
];
...
async function main() {
  ...
  const collection = mongoose.connection.db.collection("Contaminacion_Acustica");
