// Anthem/Upload/Ocupacion_Aparcamientos_Rotacionales.js
import fs from "fs";
...
const posiblesCarpetas = [
  path.resolve(__dirname, "../datos_hpe/Ocupacion_Aparcamientos_Rotacionales"),
  path.resolve(__dirname, "../datos_hpe/datos_hpe/Ocupacion_Aparcamientos_Rotacionales"),
];
...
async function main() {
  ...
  const collection = mongoose.connection.db.collection("Ocupacion_Aparcamientos_Rotacionales");
