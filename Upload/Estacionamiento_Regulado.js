// Anthem/Upload/Estacionamiento_Regulado.js
import fs from "fs";
...
const posiblesCarpetas = [
  path.resolve(__dirname, "../datos_hpe/Estacionamiento_Regulado"),
  path.resolve(__dirname, "../datos_hpe/datos_hpe/Estacionamiento_Regulado"),
];
...
async function main() {
  ...
  const collection = mongoose.connection.db.collection("Estacionamiento_Regulado");
