// Anthem/Upload/Accidentalidad.js
import fs from "fs";
...
const posiblesCarpetas = [
  path.resolve(__dirname, "../datos_hpe/Accidentalidad"),
  path.resolve(__dirname, "../datos_hpe/datos_hpe/Accidentalidad"),
];
...
async function main() {
  ...
  const collection = mongoose.connection.db.collection("Accidentalidad");
